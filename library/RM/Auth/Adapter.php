...
class Adapter implements \Zend_Auth_Adapter_Interface
{
    ...
    public function authenticate()
    {
        ...
        \RM_Logger::info($resultIdentities[0][0]->getId());
        \RM_Logger::info($resultIdentities[0][0]->getRole());
        if (($authResult = $this->_authenticateValidateResultSet($resultIdentities)) instanceof \Zend_Auth_Result) {
            var_dump($authResult);die;
            return $authResult;
        }
    ...
    protected function _authenticateSetup()
    {
        ...
        if (null !== $exceptionMessage) {
            throw new BadWolf_Doctrine_Auth_AdapterException($exceptionMessage);
        }
    ...
    protected function _authenticateQueryDql($dqlQueryObject)
    {
        try {
            $resultIdentities = $dqlQueryObject->getResult();
        } catch (Exception $e) {
            throw new BadWolf_Doctrine_Auth_AdapterException('The supplied parameters to BadWolf_Doctrine_Auth_Adapter '
