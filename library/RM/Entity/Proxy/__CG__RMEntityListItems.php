 ...
 */
class ListItems extends \RM\Entity\ListItems implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'itemId', 'name', 'defaultValue', 'displayOrder', 'listId');
    }
